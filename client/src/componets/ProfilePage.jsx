...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden font-sans selection:bg-emerald-500/30">
      ...
      <div className="relative z-10 py-10 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto mb-10">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="p-2 rounded-full bg-white/5 group-hover:bg-white/10 border border-white/5 group-hover:border-emerald-500/30 transition-all">
                <ArrowLeft className="w-5 h-5" />
              </div>
              <span className="font-medium tracking-wide">Back to Home</span>
            </button>
            <h1 className="text-3xl font-bold bg-linear-to-r from-white via-emerald-200 to-emerald-500 bg-clip-text text-transparent">
              User Profile
            </h1>
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 lg:items-start">
          <div className="lg:w-1/3 space-y-6">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/50 relative overflow-hidden group">
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                <div className="relative mb-6 group/avatar">
                  ...
                  <img
                    src={preview}
                    alt="Avatar"
                    className="relative w-32 h-32 rounded-full border-2 border-black/50 object-cover shadow-2xl"
                  />
                  <label className="absolute bottom-1 right-1 bg-emerald-500 text-white p-2.5 rounded-full shadow-lg shadow-emerald-500/20 hover:bg-emerald-400 transition-all cursor-pointer hover:scale-110 active:scale-95 border-4 border-[#0a0a0a]">
                    <input
                      type="file"
                      accept="image/*"
                      className="hidden"
                ...
                <div className="flex items-center gap-2 mt-2 text-gray-400 bg-white/5 px-3 py-1 rounded-full text-sm border border-white/5">
                ...
                {/* Institute Badge */}
                {adminDetails && (
                  <div className="mt-4 w-full p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg">
                ...
                {!adminDetails && user?.createdBy && (
                  <div className="mt-4 w-full p-3 bg-gray-500/10 border border-gray-500/20 rounded-lg">
                ...
                {!user?.createdBy && (
                  <div className="mt-4 w-full p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
              ...
              <div className="h-px bg-linear-to-r from-transparent via-white/10 to-transparent my-8"></div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-emerald-400 uppercase tracking-wider ml-1">
                      Full Name
                    </label>
                    <div className="relative group">
                      ...
                      <input
                        ...
                        disabled={loading}
                        className="w-full pl-11 pr-4 py-3.5 bg-black/40 border border-white/10 rounded-xl text-white placeholder-gray-600 focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        disabled
                        className="w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/5 rounded-xl text-gray-400 cursor-not-allowed select-none"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <School className="h-5 w-5 text-gray-500 group-focus-within:text-emerald-400 transition-colors" />
                      </div>
                      <input
                        type="text"
                        name="college"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                      <MapPin className="h-5 w-5 text-gray-500 group-focus-within:text-emerald-400 transition-colors" />
                    </div>
                    <input
                      type="text"
                      name="address"
                ...
                <div className="flex gap-4 pt-2">
                  <button
                    ...
                    onClick={() => navigate("/")}
                    disabled={loading}
                    className="flex-1 px-6 py-3.5 border border-white/10 text-gray-300 rounded-xl hover:bg-white/5 hover:text-white transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Cancel
                  </button>
                  <button
