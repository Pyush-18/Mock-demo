...
const PerformanceOverview = ({ data, darkMode = true }) => {
  const COLORS = {
    correct: '#10B981',   
    incorrect: '#EF4444', 
    skipped: '#475569',  
      ...
      <div className="max-w-7xl mx-auto">
        <div className="animate-in fade-in duration-500">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className={`text-3xl font-bold ${TEXT_PRIMARY} tracking-tight`}>
              Performance Overview
            </h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className={`${CARD_BG} border rounded-2xl p-5 backdrop-blur-sm relative overflow-hidden group hover:border-emerald-500/40 transition-colors`}>
            ...
            <div className={`${CARD_BG} border rounded-2xl p-5 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/40 transition-colors`}>
              <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
            ...
            <div className={`${CARD_BG} border rounded-2xl p-5 backdrop-blur-sm relative overflow-hidden group hover:border-purple-500/40 transition-colors`}>
              <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:opacity-20 transition-opacity">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className={`${CARD_BG} border rounded-2xl p-6 backdrop-blur-sm hover:border-slate-700 transition-colors`}>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <Legend 
                      ...
                      iconType="circle"
                      formatter={(value) => (
                        <span className="text-slate-400 ml-2 text-sm">{value}</span>
                      )}
                    />
                  </PieChart>
                </ResponsiveContainer>
