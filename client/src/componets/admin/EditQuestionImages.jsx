    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-lg flex items-center justify-center p-4 z-99">
        <motion.div
          ...
          className="bg-[#0f0f0f] border border-white/10 backdrop-blur-md rounded-2xl shadow-2xl max-w-md w-full text-gray-200"
        >
      
          <div className="flex justify-between items-center px-6 py-4 border-b border-white/10 bg-black/20 rounded-t-2xl">
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className="border-2 border-dashed border-emerald-700/50 rounded-lg p-8 text-center bg-black/30 hover:bg-black/40 transition-colors focus-within:border-emerald-500/80">
                <input
                  type="file"
                  multiple
                  accept="image/*"
                  ...
                  {files.map((file, index) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-red-400 hover:text-red-300 text-sm p-1 rounded hover:bg-red-900/40 transition-colors"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
            ...
            <div className="flex justify-end space-x-3 pt-4 border-t border-white/10">
              ...
              <button
                ...
                className="px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-[#0f0f0f] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center font-medium"
              >
                {uploading ? (
