  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md p-4">
      <motion.div
        ...
        className={`${darkBg} rounded-3xl shadow-2xl max-w-lg w-full p-8 border ${darkBorder} shadow-[0_0_50px_rgba(52,211,153,0.15)]`}
      >
        <div className="flex flex-col items-center mb-6">
          <BookOpen
            className="w-10 h-10 mb-3 text-emerald-400"
            strokeWidth={1.5}
          />
          <h2 className={`text-3xl font-bold ${headerColor} mb-2 text-center`}>
            Test Instructions
          </h2>
          <p className={`text-sm ${textColor} text-center max-w-xs`}>
        ...
        <div className="space-y-4">
          <div className="flex justify-between p-4 rounded-xl bg-white/5 border border-white/10 text-white font-medium">
          ...
          <div className="bg-[#111111] rounded-xl p-5 max-h-[250px] overflow-y-auto border border-white/5 text-sm space-y-3 custom-scrollbar">
            ...
            <p className={`${textColor} flex items-start gap-2`}>
              <ArrowRightCircle className="w-4 h-4 mt-0.5 text-emerald-500 shrink-0" />
            ...
            <p
              className={`${textColor} flex items-start gap-2 font-semibold text-yellow-400`}
            >
        ...
        <div className="mt-6 flex items-start space-x-3">
          ...
          <label
            htmlFor="agree"
            className={`text-sm leading-snug ${textColor} hover:text-white transition cursor-pointer`}
          >
        ...
        <div className="flex justify-between space-x-3 mt-8">
          <button
            onClick={onCancel}
            className="px-5 py-2.5 rounded-xl border border-white/20 text-gray-400 hover:bg-white/10 transition flex items-center gap-2"
          >
          ...
          <button
            onClick={onConfirm}
            disabled={!agreed}
            className={`px-8 py-2.5 cursor-pointer rounded-xl font-bold text-black transition flex items-center justify-center gap-2 ${
              agreed
                ? `${emeraldGradient} hover:shadow-[0_0_25px_rgba(52,211,153,0.5)] transform hover:scale-[1.02]`
